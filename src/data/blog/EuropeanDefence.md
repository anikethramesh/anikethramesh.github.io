...
This question of agency and responsibility isn’t new. The [Bhagavad Gita](https://slavoj.substack.com/p/bhagavad-gita-again) is essentially about this action under moral ambiguity. Acting when the outcome is uncomfortable, but the responsibility is still yours. (*Although this doesn't mean there's no responsibility on the designer of the defence machinery. That however is another article.*)
...
Use this file as a template for future writing:

- Duplicate the file
- Change the `title`, `pubDatetime`, `tags`, and `description`
- Replace the body with your actual piece

## Structure

Start with a sharp opening paragraph that states the idea clearly.

Then develop the argument in sections like this one.

## Notes

Keep the writing direct and topic-agnostic. The page list will automatically pick up any new post you add under `src/data/blog/`. -->
